...
describe('FractionInputValidationService', () => {
  ...
  let denominatorEqualsFiveRule: Rule,
    equalsOneAndHalfRule: Rule,
    equalsOneRule: Rule,
    equalsThreeByTwoRule: Rule,
    equivalentToOneAndSimplestFormRule: Rule,
    equivalentToOneRule: Rule,
    ...
    HasNoFractionalPart: Rule,
    greaterThanMinusOneRule: Rule,
    integerPartEqualsOne: Rule,
    integerPartEqualsZero: Rule,
    lessThanTwoRule: Rule,
    nonIntegerRule: Rule,
    numeratorEqualsFiveRule: Rule,
  ...
  it(
    'should catch equivalent followed by equals same value' + 'as redundant',
    function () {
  ...
  it(
    'should catch if not allowNonzeroIntegerPart and ' +
  ...
  it(
    'should allow if not allowNonzeroIntegerPart and ' +
